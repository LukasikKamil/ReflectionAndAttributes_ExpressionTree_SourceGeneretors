...
using ALLinONE.Shared; // CoderAttribute
...
{
    // Filtering attributes CompilerGeneratedAttribute
    ...
    foreach(MemberInfo member in members)
    {
        ...
        WriteLine("{0}: {1} ({2} {3})", member.MemberType, member.Name, member.DeclaringType?.Name, obsolete is null ? "" : $"Obsolete! {obsolete.Message}");
